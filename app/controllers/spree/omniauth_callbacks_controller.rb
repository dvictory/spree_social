class Spree::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  def facebook
          ...
          if !authentication.nil?  #We already have an authentication
            ...
            if current_user and current_user.id == authentication.user.id
              ...
              flash[:notice] = "Your #{auth_hash['provider'].capitalize} account is already linked with an account. <a href=\"/login\">Want to sign in?</a>"
